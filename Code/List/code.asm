...
_status_dingin:
	.DB  0x44,0x69,0x6E,0x67,0x69,0x6E,0x0
_status_hangat:
	.DB  0x48,0x61,0x6E,0x67,0x61,0x74,0x0
_status_panas:
	.DB  0x50,0x61,0x6E,0x61,0x73,0x0

_0x0:
	.DB  0x54,0x65,0x6D,0x70,0x3A,0x20,0x25,0x2E
	.DB  0x31,0x66,0x20,0x43,0x0,0x53,0x74,0x61
	.DB  0x74,0x75,0x73,0x3A,0x20,0x25,0x73,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020000:
...
; 0000 0041 return status_dingin;
	LDI  R30,LOW(_status_dingin*2)
	LDI  R31,HIGH(_status_dingin*2)
	RJMP _0x20C0003
...
; 0000 0043 return status_hangat;
	LDI  R30,LOW(_status_hangat*2)
	LDI  R31,HIGH(_status_hangat*2)
	RJMP _0x20C0003
; 0000 0044 } else {
_0xC:
; 0000 0045 return status_panas;
	LDI  R30,LOW(_status_panas*2)
	LDI  R31,HIGH(_status_panas*2)
	RJMP _0x20C0003
; 0000 0046 }
; 0000 0047 }
; .FEND
